...
const _workshopData = getWorkshopById("bookmark-journal-sheraton");
...
async function checkQuota() {
    ...
    try {
        ...
        const currentCount = counts['bookmark-journal-sheraton'] || 0;
        const maxQuota = _workshopData.maxQuota || 50;
...
form.addEventListener('submit', async (e) => {
    ...
    payload.workshopType = 'bookmark-journal-sheraton';
    ...
    try {
        ...
        if (result.status === 'success') {
            const params = new URLSearchParams({
                ...
                workshop: 'bookmark-journal-sheraton',
